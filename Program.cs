...
namespace PALACIOH
{
    public class Program
    {
        ...
        public void Extraer()
        {
            ...
            DirectoryInfo di24 = new DirectoryInfo(@"\\10.223.208.41\Users\Administrator\Documents\PALACIOH");
            ...
            if (cantidad24 > 0)
            {
                foreach (var item in files24)
                {
                    ...
                    string sourceFile = @"\\10.223.208.41\Users\Administrator\Documents\PALACIOH\" + item.Name;
                    ...
                    if (r)
                    {
                        ...
                        if (otds.Rows.Count > 0)
                        {
                            foreach (DataRow isegm in otds.Rows)
                            {
                                ...
                                string destinationFile = @"\\10.223.208.41\Users\Administrator\Documents\PALACIOPROCESADAS\" + item.Name;
